...
interface SelectGroupOneProps {
  PropertyType: (selectedOption: string) => void;
}

const SelectGroupOne: React.FC<SelectGroupOneProps> = ({ PropertyType }) => {
  const [selectedOptionLocal, setSelectedOptionLocal] = useState<string>("");
  ...
  return (
    <div className="mb-4">
      <label className="mb-1 block text-black dark:text-white"> Subject </label>
